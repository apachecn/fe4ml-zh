...
是Bag-of-Words的自然延伸。 n-gram是n个有序的tokens。一个词基本上是一个1-gram，也被称为一个单元。标记后，计数机制可以将单个词进行计数，或将重叠序列计数为n-gram。例如，“Emma knocked on the door”这句话会产生n-gram，如“Emma knocked”，“knocked on”，“on the”，”the door”。
